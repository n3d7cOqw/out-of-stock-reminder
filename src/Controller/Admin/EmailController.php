...
//                            );
        ...
        if (count($defaultRule) > 0) {
            ...
            foreach ($products as $product) {
                if (!in_array($product["id_product"], $checkedRules)) {
                    ...
                    if ($quantity > $defaultRule[0]->getThreshold()){
        ...
        $this->addFlash("success", $this->trans("Emails was successfully send", "Modules.OutOfStockReminder.Admin"));
